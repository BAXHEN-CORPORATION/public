...
export type FlipCardClassKey = keyof FlipCardClasses;

export function getFlipCardUtilityClass(slot: string): string {
  return generateUtilityClass("BaxFlipCard", slot, "Bax");
}

const flipCardClasses: FlipCardClasses = generateUtilityClasses(
  "BaxFlipCard",
  [
    "root",
    "outlined",
...
export default flipCardClasses;
